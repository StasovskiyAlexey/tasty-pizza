    ...
    <header className='header bg-orange-400'>
      <div className="header-container max-w-7xl mx-auto flex items-center justify-between lg:min-h-16 xs:max-h-14 py-4 w-11/12">
        ...
        <div className='flex gap-x-2'>
          <button onClick={() => mainStore.toggler('auth', true)} className='p-3 rounded-full shadow-md bg-white transition'><UserRound color='#000' size={18} /></button>
          <div className="relative inline-block">
            ...
            >
              <ShoppingCart color="#000" size={18} />
            </button>
